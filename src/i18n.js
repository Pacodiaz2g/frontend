...
export const i18n = new Jed({
    locale_data: {
        ...
        messages: {
            ...
            "site's name": ['Nombre del sitio'],
            "e.g. Anzu's community": ['Ej. Comunidad de Anzu'],
            'Showed around the site, name of your community': [
                'Mostrado alrededor del sitio, el nombre de tu comunidad',
            ],
            "Site's description": ['Descripción del sitio'],
            'For metadata, searching results': [
                'Para metadatos, resultados de busqueda y dar a conocer tu comunidad.',
            ],
            'e.g. https://comunidad.anzu.io': ['Ej. https://comunidad.anzu.io'],
            "Absolut URL where Anzu's installation lives. Using an inaccessible address may cause you can't access to the site": [
            ...
            'Navigation menu': ['Menu de navegación'],
            'Showed at the top of the site. (- = +)': [
